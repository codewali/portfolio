  ...
  return (
    <div className="portfolio-container">
      ...
      <section className="hero-section">
        ...
        {/* Trinket Items - MASSIVE and tightly clustered */}
        {/* Top cluster - tighter grouping */}
        <div className="trinket-item trinket-emoji" style={{top: '8%', left: '30%', rotate: '-15deg'}}>
        ...
        <div className="trinket-item trinket-emoji" style={{top: '6%', left: '43%', rotate: '8deg'}}>
          <div className="trinket-content">
            <div className="emoji-display">🎓</div>
        ...
        <div className="trinket-item trinket-emoji" style={{top: '8%', right: '30%', rotate: '-12deg'}}>
          <div className="trinket-content">
            <div className="emoji-display">📍</div>
        ...
        <div className="trinket-item trinket-emoji" style={{top: '18%', left: '34%', rotate: '12deg'}}>
          <div className="trinket-content">
            <div className="emoji-display">🎯</div>
        ...
        <div className="trinket-item trinket-emoji" style={{top: '20%', left: '47%', rotate: '-8deg'}}>
          <div className="trinket-content">
            <div className="emoji-display">🎨</div>
        ...
        <div className="trinket-item trinket-emoji" style={{top: '18%', right: '34%', rotate: '10deg'}}>
          <div className="trinket-content">
            <div className="emoji-display">✨</div>
        ...
        {/* Bottom cluster - tighter grouping */}
        <div className="trinket-item trinket-emoji" style={{bottom: '8%', left: '30%', rotate: '14deg'}}>
          <div className="trinket-content">
            <div className="emoji-display">💼</div>
        ...
        <div className="trinket-item trinket-emoji" style={{bottom: '6%', left: '43%', rotate: '-11deg'}}>
          <div className="trinket-content">
            <div className="emoji-display">🧭</div>
        ...
        <div className="trinket-item trinket-emoji" style={{bottom: '8%', right: '30%', rotate: '9deg'}}>
          <div className="trinket-content">
            <div className="emoji-display">🌸</div>
        ...
        <div className="trinket-item trinket-emoji" style={{bottom: '18%', left: '34%', rotate: '-13deg'}}>
          <div className="trinket-content">
            <div className="emoji-display">☕</div>
        ...
        <div className="trinket-item trinket-emoji" style={{bottom: '20%', left: '47%', rotate: '7deg'}}>
          <div className="trinket-content">
            <div className="emoji-display">📊</div>
        ...
        <div className="trinket-item trinket-emoji" style={{bottom: '18%', right: '34%', rotate: '-10deg'}}>
          <div className="trinket-content">
            <div className="emoji-display">🏢</div>
